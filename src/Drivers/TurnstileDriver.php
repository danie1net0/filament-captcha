...
class TurnstileDriver extends CaptchaDriver
{
    ...
    public function verify(string $token): bool
    {
        ...
        $verifyUrl = $this->config['verify_url'] ?? 'https://challenges.cloudflare.com/turnstile/v0/siteverify';
    ...
    {
        return 'filament-captcha::drivers.turnstile';
    }
}
